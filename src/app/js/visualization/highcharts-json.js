(function() {
    ...
    window.prepareHighchartsJson = function(data) {
        ...
        _.forEach(cells, function(c) {
            series[c["geometry__country_level0.name"]].push(c["gdp_per_capita__amount_sum"]);
        });
        ...
        var defaultCountries = ["sweden", "germany", "france", "pakistan", "australia", "new zealand"]
